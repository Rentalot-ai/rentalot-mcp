...
const TOOL_ENDPOINT_MAP: Record<string, [string, string]> = {
  ...
  get_property: ["get", "/api/v1/properties/{propertyId}"],
  create_property: ["post", "/api/v1/properties"],
  update_property: ["patch", "/api/v1/properties/{propertyId}"],
  delete_property: ["delete", "/api/v1/properties/{propertyId}"],
  // Contacts
  list_contacts: ["get", "/api/v1/contacts"],
  get_contact: ["get", "/api/v1/contacts/{contactId}"],
  create_contact: ["post", "/api/v1/contacts"],
  update_contact: ["patch", "/api/v1/contacts/{contactId}"],
  delete_contact: ["delete", "/api/v1/contacts/{contactId}"],
  // Showings
  list_showings: ["get", "/api/v1/showings"],
  get_showing: ["get", "/api/v1/showings/{showingId}"],
  create_showing: ["post", "/api/v1/showings"],
  update_showing: ["patch", "/api/v1/showings/{showingId}"],
  delete_showing: ["delete", "/api/v1/showings/{showingId}"],
  ...
  get_conversation: ["get", "/api/v1/conversations/{conversationId}"],
  search_conversations: ["get", "/api/v1/conversations/search"],
  list_conversation_messages: ["get", "/api/v1/conversations/{conversationId}/messages"],
  // Messages
  send_message: ["post", "/api/v1/messages"],
  // Drafts
  list_drafts: ["get", "/api/v1/drafts"],
  get_draft: ["get", "/api/v1/drafts/{draftId}"],
  create_draft: ["post", "/api/v1/drafts"],
  update_draft: ["patch", "/api/v1/drafts/{draftId}"],
  send_draft: ["post", "/api/v1/drafts/{draftId}/send"],
  delete_draft: ["delete", "/api/v1/drafts/{draftId}"],
  // Follow-ups
  list_followups: ["get", "/api/v1/followups"],
  get_followup: ["get", "/api/v1/followups/{followupId}"],
  create_followup: ["post", "/api/v1/followups"],
  delete_followup: ["delete", "/api/v1/followups/{followupId}"],
  // Workflows
  list_workflows: ["get", "/api/v1/workflows"],
  get_workflow: ["get", "/api/v1/workflows/{workflowId}"],
  create_workflow: ["post", "/api/v1/workflows"],
  update_workflow: ["patch", "/api/v1/workflows/{workflowId}"],
  delete_workflow: ["delete", "/api/v1/workflows/{workflowId}"],
  trigger_workflow_run: ["post", "/api/v1/workflows/runs"],
  list_workflow_runs: ["get", "/api/v1/workflows/runs"],
  get_workflow_run: ["get", "/api/v1/workflows/runs/{runId}"],
  // Webhooks
  list_webhooks: ["get", "/api/v1/webhooks"],
  create_webhook: ["post", "/api/v1/webhooks"],
  get_webhook: ["get", "/api/v1/webhooks/{webhookId}"],
  ...
  // Property Images
  list_property_images: ["get", "/api/v1/properties/{propertyId}/images"],
  presign_image_upload: ["post", "/api/v1/properties/{propertyId}/images/presign"],
  confirm_image_upload: ["post", "/api/v1/properties/{propertyId}/images/confirm"],
  delete_property_images: ["delete", "/api/v1/properties/{propertyId}/images"],
  reorder_property_images: ["patch", "/api/v1/properties/{propertyId}/images/reorder"],
  presign_image_batch: ["post", "/api/v1/properties/{propertyId}/images/presign-batch"],
  confirm_image_batch: ["post", "/api/v1/properties/{propertyId}/images/confirm-batch"],
  import_property_images: ["post", "/api/v1/properties/{propertyId}/images/import"],
  get_image_import_job: ["get", "/api/v1/properties/{propertyId}/images/import/{jobId}"],
  // Sessions
  list_sessions: ["get", "/api/v1/sessions"],
  get_session: ["get", "/api/v1/sessions/{sessionId}"],
  review_session: ["patch", "/api/v1/sessions/{sessionId}/review"],
  // Bulk Import
